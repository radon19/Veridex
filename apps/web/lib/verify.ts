// Verify order — must match Lambda: hash -> sig -> holder -> revoked -> expired
export function verifyStatus(
  m: { contentHash: string; appSignatureValid: boolean; holder: string; owner: string; revoked: boolean; expired: boolean },
  actualHash: string,
  ownerOnChain: string
) {
